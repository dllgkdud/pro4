	...
	<div class="row column text-center">
		...
		<form action="${path1 }/member/update.do" method="post" onsubmit="return updateCheck(this)">
			<tbody>
				...
				<tr>
					<th>비밀번호</th>
					<td><input type="password" name="userpw" id="userpw" placeholder="비밀번호" value="${member.userpw }" required /></td>
				</tr>
 				<tr>
					<th>비밀번호 확인</th>
				...
				<tr>
					<th>이메일</th>
					<td><input type="text" name="email" id="email" placeholder="email@naver.com" value="${member.email }" required /></td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td><input type="text" name="tel" id="tel" placeholder="010-XXXX-XXXX" maxlength="13" value="${member.tel }" required /></td>
				</tr>
				<tr>
					<th>주소</th>
					<td>

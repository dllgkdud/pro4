...
<div class="row column text-center">
	<h2>보도자료</h2>
	<hr>
	<form action="${path1 }/news/update.do" method="post">
		<table>
			<tbody>
				<tr>
					<th>제목</th>
					<td>
						...
						<input type="text" name="ntitle" id="ntitle" placeholder="제목을 입력하십시오." value="${dto.ntitle }" maxlength="300" required />
					</td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea cols="100" rows="10" name="ncontent" id="ncontent" placeholder="내용을 입력하십시오." style="resize: none;" maxlength="2900" required>${dto.ncontent }</textarea>
						<script>

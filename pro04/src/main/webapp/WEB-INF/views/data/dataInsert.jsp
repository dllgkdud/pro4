	...
	<form action="${path1 }/data/insert.do" method="post">
		<table>
			<tbody>
				<tr>
					<th>제목</th>
					<td><input type="text" name="dtitle" id="dtitle" placeholder="제목을 입력하십시오." maxlength="300" required /></td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea cols="100" rows="10" name="dcontent" id="dcontent" placeholder="내용을 입력하십시오." style="resize: none;" maxlength="900" required></textarea>
						<script>
